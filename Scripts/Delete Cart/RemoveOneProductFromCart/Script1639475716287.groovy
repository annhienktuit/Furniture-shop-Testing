...
WebUI.click(findTestObject('Object Repository/Page_Konsept/span_Remove'))

WebUI.click(findTestObject('Object Repository/Page_Konsept/button_Update Cart'))

WebUI.click(findTestObject('Object Repository/Page_Konsept/h2_Your cart is empty'))
