...
WebUI.click(findTestObject('Object Repository/Page_Konsept/input_Subtotal_PrivateSwitchBase-input css-1m9pwf3'))

WebUI.click(findTestObject('Object Repository/Page_Konsept/p_Total 30.00'))
