...
WebUI.click(findTestObject('Object Repository/Page_Konsept/div_MY ACCOUNTAccount DetailShipping Inform_66f5a4'))

WebUI.click(findTestObject('Object Repository/Page_Konsept/button_Update Password'))

WebUI.click(findTestObject('Object Repository/Page_Konsept/p_Old password is a required field'))
