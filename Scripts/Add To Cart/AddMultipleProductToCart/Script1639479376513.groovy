...
WebUI.click(findTestObject('Object Repository/Page_Konsept/h5_Aloe'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Konsept/span_'))
...
WebUI.click(findTestObject('Object Repository/Page_Konsept/div_Aloe'))
